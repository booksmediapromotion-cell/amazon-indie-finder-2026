"""
Amazon Indie Author Finder 2026 - FIXED VERSION
"""
...
# Footer
st.divider()
st.markdown('<div style="text-align: center; color: #64748b; padding: 1rem;"><p>Amazon Indie Author Finder 2026 | Version 2.1</p></div>', unsafe_allow_html=True)
